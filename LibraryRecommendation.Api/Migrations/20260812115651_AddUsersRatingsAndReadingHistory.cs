...
{
    /// <inheritdoc />
    public partial class AddUsersRatingsAndReadingHistory : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavouriteGenres = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    FavouriteAuthors = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReadingHistory_UserId_BookId",
                table: "ReadingHistory",
                columns: new[] { "UserId", "BookId" },
                unique: true);
        }
